...
<head>
    ...
    <link rel="stylesheet" href="css/pause_vertical.css" />
    <link rel="stylesheet" href="css/loadinganimation2.css" />
</head>
...
<body>
    <div>
        ...
        <div class="container">
            <h1 class="pause-title"><?php echo($pause_cfg["title"]) ?></h1>
            <h2 class="pause-description-html"><?php echo($pause_cfg["description"]) ?></h2>
        </div>
